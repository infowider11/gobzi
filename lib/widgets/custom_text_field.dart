...
class CustomTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    {
      return Container(
        height: maxLines == null ? 90 : height,
        width:width ?? MediaQuery.of(context).size.width,
        margin: EdgeInsets.symmetric(
            horizontal: horizontalPadding ? 16 : 0, vertical: 8),
        decoration: BoxDecoration(
          color: headingText != null ? Colors.transparent : bgColor,
          border: headingText != null ? null : border == null ? Border.all(
              color: Color(0xffE1E1E1), width: 0.5) : border,
          ...
          children: [
              ...
              Column(
                children: [
                  ParagraphText(headingText!, fontWeight: FontWeight.w600,
                    fontSize: 14,
                    fontFamily: 'poppins',
                    color: textColor?? colorProvider.primaryTextColor,),
                  vSizedBox10,
                ],
              ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: colorProvider.textfieldColor
              ),
              child: Stack(
                children: [
                  TextField(
                    cursorColor: colorProvider.blackColor,
                    maxLines: maxLines ?? 1,
                    focusNode: focusNode,
                    ...
                    decoration: InputDecoration(
                      enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(color: colorProvider.textfieldColor, width: 0.0),
                      ),
                      ...
                      contentPadding: EdgeInsets.symmetric(
                          vertical: contentPadding ?? 15, horizontal: 20),
                      ...
                      hintStyle: TextStyle(
                          color: hintcolor?? colorProvider.primaryTextColor.withOpacity(0.7),
                          fontSize: 12,
                          fontFamily: 'poppins'
                      ),
                      labelStyle: TextStyle(
                          color:  colorProvider.blackColor,
                          fontSize: 12,
                          fontFamily: 'poppins'
                      ),
